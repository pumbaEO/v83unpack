...
// реквизиты обработки (удалить или утвердить) ------

Перем БылаИнициализация Экспорт;
Перем ВключенРежимОтладки Экспорт;
Перем ВыводитьСообщенияВЖурналРегистрации Экспорт;
Перем ИспользоватьРежимОтложенногоЗапускаВыгрузкиМодулейИзКонфигуратора Экспорт;
Перем ЗадержкаЗапускаВыгрузкиМодулейИзКонфигуратора Экспорт;
...
Функция ВыгрузитьМодули(ИмяКаталогаБазы, Пользователь, Пароль, резКаталогВыгрузкиВсехМодулей83) //Экспорт
	...
	Сообщить(ПутьКаталогаВыгрузкиДанных);
	МассивФайлов = НайтиФайлы(ПутьКаталогаВыгрузкиДанных,"*.*");
