...
Функция ПолучитьПараметрыИнициализации() Экспорт
	...
	Параметры.Вставить("ПутьКФайлуХранилища1С", "");
	...
	Параметры.Вставить("НомерВерсииХранилища", ""); // последний
	Параметры.Вставить("ВерсияПлатформыИБ", "8.3");
...
Функция ЗапуститьСкрытоеПриложениеИДождатьсяЗавершения(Знач СтрокаЗапуска, ТекущийКаталог = "\.") Экспорт 
