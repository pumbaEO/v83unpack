...
Функция СинхронизироватьХранилищеКонфигурацийСГит(СтруктураПараметров) Экспорт
	...
	Пока успешно Цикл
		...
		Если СтрокаВерсии <> Неопределено Тогда
			...
			ПутьКФайлуСинхронизацииВерсий = СтруктураПараметров.КаталогВыгрузки+"\VERSION";
...
Процедура Тест_ДолженПодготовитьРепозитарийКСинхронизацииСХранилищем() Экспорт
	...
	СтрокиПроверки.Добавить("60248d56-c966-4648-8f43-6606d369fb67;Администратор <Администратор@localhost>");
	СтрокиПроверки.Добавить("00902af9-0d35-4c8b-a6c0-381796159ec1;Отладка <Отладка@localhost>");
...
Процедура ТестДолжен_СинхронизироватьХранилищеКонфигурацийСГит() Экспорт	
	...
	ЗаписатьФайлВерсийГит(лПутьКаталогаВыгрузкиДанных + "\VERSION",0);
