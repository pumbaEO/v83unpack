...
Функция РежимОтладки(Знач УстановитьОтладку = Неопределено)
...
Функция ВыгрузитьФайлВерсийИзФайлаХранилища1С(ПутьКФайлуХранилища1С, резПутьКХМЛФайлуВерсийХранилища1С, резПутьКХМЛФайлуПользователейХранилища1С, резПутьКТаблицамИзФайлаХранилища1С = Неопределено) Экспорт
	...
	лПутьКТаблицамИзФайлаХранилища1С = СоздатьУникальныйКаталог("t1CD_tmp")+"\";
...
Процедура СформироватьПервичныйФайлПользователейДляGit(Знач ТаблицаПользователейХранилища, Знач ВыходнойФайл) Экспорт
...
Процедура Тест_ДолженПодготовитьРепозитарийКСинхронизацииСХранилищем() Экспорт
	...
	Если Не ВыгрузитьФайлВерсийИзФайлаХранилища1С(ТестФайлХранилища, резПутьКХМЛФайлуВерсийХранилища1С, резПутьКХМЛФайлуПользователейХранилища1С) Тогда
	...
	СформироватьПервичныйФайлПользователейДляGit(ТаблицаПользователейХранилища, ВыходнойФайл);
	// проверка
	Стр = "";
	СчетчикПроверки = 0;
...
Функция ИнициализироватьТестовоеХранилищеГит(Знач КаталогРепозитория)
	...
	Возврат ЗапуститьСкрытоеПриложениеИДождатьсяЗавершения("git init", КаталогРепозитория);
