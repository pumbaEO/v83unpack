...
Процедура Инициализация() Экспорт
	...
	Если мНастройки = Неопределено Тогда
		...
		Если Отладка Тогда // Отладочный запуск вне билд-сервера
			...
			мНастройки.Вставить("ИмяСервера", "WS-MSK-A2981:2041");
			мНастройки.Вставить("АдресАгентаСервера", "WS-MSK-A2981:2040");
			мНастройки.Вставить("АдминистраторКластера", "Иван");
			мНастройки.Вставить("ПарольАдминистратораКластера", "123");
			мНастройки.Вставить("КлассCOMСоединения", "V83.ComConnector");
			
			// Параметры рабочей базы
			мНастройки.Вставить("ИмяБазы", "srv");
			мНастройки.Вставить("АдминистраторБазы", "Админ");
			мНастройки.Вставить("ПарольАдминистратораБазы", "123");
...
Сообщить("мНастройки.АдминистраторБазы = <"+мНастройки.АдминистраторБазы+">");
Сообщить("мНастройки.ПарольАдминистратораБазы = <"+мНастройки.ПарольАдминистратораБазы+">");
