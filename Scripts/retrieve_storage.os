...
Сообщить("АргументыКоманднойСтроки(0) "+АргументыКоманднойСтроки[0]);
Сообщить("АргументыКоманднойСтроки.Количество()-1 "+АргументыКоманднойСтроки[АргументыКоманднойСтроки.Количество()-1]);
